...
const mk = {
  auth: {
    ...
    errors: {
      ...
      identitySettings: 'Нема пристап до поставките. Ако користите git-gateway, не заборавајте да ја активирате услугата Identity и Git Gateway.'
    }
  },
  app: {
    header: {
  ...
  editor: {
    ...
    editorControlPane: {
      ...
      i18n: {
        ...
        copyFromLocaleConfirm: 'Дали сакате да ги пополните податоците од јазикот %{locale}?\nСите постоечки содржини ќе бидат презапишани.'
      }
    },
    editor: {
      ...
      onDeleteWithUnsavedChanges: 'Дали сте сигурни дека сакате да го избришете овој објавен запис и незачуваните промени од тековната сесија?',
      onDeletePublishedEntry: 'Дали сте сигурни дека сакате да го избришете овој објавен запис?',
      onDeleteUnpublishedChangesWithUnsavedChanges: 'Ова ќе ги избрише сите необјавени промени во овој запис и незачуваните промени од тековната сесија. Дали сакате да продолжите?',
      onDeleteUnpublishedChanges: 'Сите необјавени промени ќе бидат избришани. Дали сакате да продолжите?',
    ...
    editorToolbar: {
      ...
      saving: 'Се зачувува...',
      save: 'Зачувај',
      statusInfoTooltipDraft: 'Статусот на записот е поставен како нацрт. За да го финализирате и поднесете за преглед, поставете го статусот "Во рецензија".',
      statusInfoTooltipInReview: 'Записот е во рецензија, не се потребни дополнителни акции. Сепак, можете да направите дополнителни промени додека е во рецензија.',
      deleting: 'Се брише...',
      updating: 'Се ажурира...',
  ...
  ui: {
    ...
    errorBoundary: {
      ...
      privacyWarning: 'При отворање на тикет, автоматски се пополнува со порака за грешка и податоци за дебагирање.\nПроверете дали податоците се точни и отстранете ги доверливите информации ако ги има.',
      recoveredEntry: {
  ...
  workflow: {
    workflow: {
      ...
      newPost: 'Нова објава',
      description: '%{smart_count} запис чека за рецензија, %{readyCount} подготвен за објава. |||| %{smart_count} записи чекаат за рецензија, %{readyCount} подготвени за објава.',
      dateFormat: 'MMMM D'
    },
    workflowCard: {
    ...
    workflowList: {
      ...
      onPublishingNotReadyEntry: 'Само записи со статус "Спремно" можат да се објават. Повлечете ја картичката во колоната "Спремно" за да го овозможите објавувањето.',
...
var _default = exports.default = mk;