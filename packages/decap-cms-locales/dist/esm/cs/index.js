...
const cs = {
  ...
  editor: {
    ...
    editor: {
      ...
      onDeleteWithUnsavedChanges: 'Opravdu chcete vymazat tuto publikovanou položku a všechny neuložené změny z této relace?',
      onDeletePublishedEntry: 'Opravdu chcete smazat tuto publikovanou položku?',
      onDeleteUnpublishedChangesWithUnsavedChanges: 'Tato akce vymaže všechny nepublikované změny v této položce a také všechny neuložené změny z této relace. Chcete položku skutečně vymazat?',
      onDeleteUnpublishedChanges: 'Všechny nepublikované změny v této položce budou vymazány. Chcete ji skuteně vymazat?',
    ...
    editorToolbar: {
      ...
      saving: 'Ukládání…',
      save: 'Uložit',
      statusInfoTooltipDraft: 'Položka je ve stavu konceptu. Po dokončení úprav ji označte stavem ‚V revizi‘.',
      statusInfoTooltipInReview: 'Položka je označena jako připravená k revizi, žádná další akce není třeba. Můžete ovšem provádět další změny, zatímco probíhá revize.',
      deleting: 'Vymazávání…',
  ...
  workflow: {
    workflow: {
      ...
      description: '%{smart_count} čeká na schválení, %{readyCount} připraven k publikaci. |||| %{smart_count} čeká na schválení, %{readyCount} připraveno k publikaci. ',
      dateFormat: 'MMMM D'
    },
    workflowCard: {
    ...
    workflowList: {
      ...
      onPublishingNotReadyEntry: 'Pouze položky se stavem "Připraveno" mohou být publikovány. Pro umožnění publikace musíte přetáhnout kartu do sloupce "Připraveno"',
...
var _default = exports.default = cs;